...
train_df = pd.read_csv("/path_to_your_df/final_training_dataset_oversampled_non_heterogeneous.csv")
test_df = pd.read_csv("/path_to_your_df/final_test_dataset_non_heterogeneous.csv")
...
model.save('/path_to_your_models_directory/model_multiclass_31classes_256_256.h5')
